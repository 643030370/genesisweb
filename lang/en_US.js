...
• Internal and external decision making`,
	...
	page: {
		...
		topBanner: {
			...
			whatIsH1: 'What is',
			whatIsH2: 'Richverse',
			whatIsDesc1: "Richverse Web3 is the world's first SocialFi network driven by XR technology. It aims to build a social network driven by XR technology and community autonomy; and a Web3 integrating Gamefi, NFT aggregated transactions and Socialfi. Based on the interests and professional background of the team,  vision is to make virtual interactions more realistic and interesting.",
			whatIsDesc2: 'Genesis not only allows players to "Play to Earn", but also allows players to "Play to learn & learn to earn".  To obtain tokens, not only in the traditional PVE mode, but also in the PVP competitive mode, players have to manipulate skilled techniques. Players can gain new friends while acquiring assets in different scenes of the game through constellation immigrants of different levels. Based on the role of constellation immigrants, Genesis has created NFT assets such as space debris, virtual buildings, character equipment and so on. From a product path perspective, both 《Genesis》 and 《Find me》 have strong social genes. They are laying the groundwork for user accumulationfor Richverse Web3, a social network driven by XR technology.The experiences connect and build on each other,which allows the Richverse metaverse to progressively expand；Whether it is Gamefi - 《Genesis》 with social functions and greater playability or SocialFi - 《 Find me》 based on AR, GPS technology and facial recognition algorithm, Richverse Web3 is depicting a new SocialFi world.'
		},
		homeAnims: {

	...
	<view class="pos-real" :class="{'content-sm': !$bigScreen, 'content-lg': $bigScreen}">
						...
						<view class="popup" v-show="show">
							<view class="popup-info">
								...
								<view class='popup-center'>
									...
									<view class="list" @click="_WalletContract">
		...
		<view id="page7" class="page page7">
			...
			<view class="partner-wrapper">
				<view class="h-box flex-wrap justify-center">
					<image class="partner-logo" v-for="(item, idx) in partners.slice(0, 7)" :key="idx" :src="item.logo"></image>
				</view>
			<!-- 	<view class="h-box flex-wrap justify-center">
		...
		<view class="footer v-box">
			...
			<view class="h-box audit flex-extend justify-between">
				...
				<text class="link label">{{$t('label.gameBackground')}}</text>
...
<script>
	...
	export default {
		...
		methods: {
			viewWhitepaper() {
				uni.navigateTo({
					url: "/pages/common/pdfViewer/pdfViewer?url=https://d2n9tyap8kl1by.cloudfront.net/Whitepaper.pdf"
				})
			},
			navTo(href) {
				if (href) {
 ...
 <template>
 	<view class="pos-real" :class="{'content-sm': !$bigScreen, 'content-lg': $bigScreen}">
 		...
 		<view id="page7" class="page page7">
 			...
 			<view class="partner-wrapper">
 				<view class="h-box flex-wrap justify-center">
 					<image class="partner-logo" v-for="(item, idx) in partners.slice(0, 9)" :key="idx" :src="item.logo"></image>
 				</view>
 			<!-- 	<view class="h-box flex-wrap justify-center">
 					<image class="partner-logo" v-for="(item, idx) in partners.slice(4, 7)" :key="idx" :src="item.logo"></image>
 				</view> -->
